...
try:
    ...
    print("[Scenario] ROS2 Control receiver found")
except ImportError as e:
    ROS2_CONTROL_AVAILABLE = False
    print(f"[Scenario] ROS2 Control not available: {e}")
...
class MHL_Sensor_Example_Scenario():
    ...
    def _setup_ros2_control(self):
        ...
        try:
            ...
            self._ros2_control_receiver.initialize(enable_ros2=True)
            self._ros2_control_receiver._setup_ros2_control_mode(self._ros2_control_mode)
